...
export function SiteHeader() {
  ...
  return (
    <>
      {/* <header 
        className={cn(
          "fixed left-0 top-0 z-50 w-full border-b backdrop-blur-[12px] transition-transform duration-300",
          isVisible ? "translate-y-0" : "-translate-y-[100%] pointer-events-none opacity-0"
        )}
      >
        <div className={cn(
          "container flex h-[3.5rem] items-center justify-between translate-y-[-1rem] animate-fade-in [--animation-delay:600ms]"
        )}>
