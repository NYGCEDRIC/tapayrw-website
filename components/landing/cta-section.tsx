...
const tiles = [
  {
    ...
    bg: (
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-1/2 w-1/2 -translate-x-1/2 -translate-y-1/2 overflow-visible rounded-full bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500 opacity-70 blur-[20px] filter"></div>
    ),
  },
  {
    icon: <Shield className="size-full" />,
    bg: (
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-1/2 w-1/2 -translate-x-1/2 -translate-y-1/2 overflow-visible rounded-full bg-gradient-to-r from-blue-500 via-indigo-500 to-violet-500 opacity-70 blur-[20px] filter"></div>
    ),
  },
  {
    icon: <CreditCard className="size-full" />,
    bg: (
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-1/2 w-1/2 -translate-x-1/2 -translate-y-1/2 overflow-visible rounded-full bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 opacity-70 blur-[20px] filter"></div>
    ),
  },
];
            ...
            <div className="absolute z-10">
              ...
              <div className="z-10 mt-4 flex flex-col items-center text-center text-primary">
                ...
                <p className="mt-2 max-w-md">
                  Accept NFC payments instantly, anywhere in Rwanda. Fast, secure, and hassle-free.
                </p>
