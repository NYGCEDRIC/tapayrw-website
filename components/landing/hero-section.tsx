...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      Tapay provides a modern payment experience, combining NFC-enabled payments,
        <br className="hidden md:block" /> automated billing, and real-time tracking to manage finances efficiently and securely.
      </p>
      <Button
        asChild
        className="translate-y-[-1rem] animate-fade-in gap-1 rounded-lg 
          bg-gradient-to-r from-primary to-primary/80 
          hover:from-primary/90 hover:to-primary/70
          text-white dark:text-black opacity-0 
